                ...
                foreach ($hasil as $value) : $i++; ?>
                    <div class="col-lg-3">
                        <div class="kotak-item" id="gambar1">
                            ...
                            <p class="harga-item">Rp. <?php echo $value['harga']; ?>/hari</p>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#Modal<?php echo $value['nama_barang']; ?>">Selengkapnya</button>
                        </div>
                    </div>
                    <!-- Modal -->
                    <div class="modal fade" id="Modal<?php echo $value['nama_barang']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="ModalLabel"><?php echo $value['nama_barang']; ?></h5>
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="img/upload/<?php echo $value['gambar']; ?>" alt="" class="img-fluid">
                                            </div>
                                            <div class="col-md">
                                                <ul class="list-group">
                                                    <li class="list-group-item">Nama Barang : <?php echo $value['nama_barang']; ?></li>
                                                    ...
                                                    <li class="list-group-item">Keterangan Barang : <?php echo $value['ket_barang']; ?></li>
