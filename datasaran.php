...
<body>
    ...
    <div class="row no-gutters jarnav">
        ...
        <div class="col-md-10 p-3 pt-2">
            <h4><i class="fas fa-archive"></i> DATA SARAN</h4>
            ...
            <div id="Artikel" class="tabcontent jartab">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM kotak_saran"; //buat query sql
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="datasaran_hapus.php?id=<?php echo $data['id']; ?>" onclick="return confirm('apakah anda yakin?')" class="btn btn-primary">Delete</a></td>
                            </tr>
                        <?php
                        }
                        ?>
