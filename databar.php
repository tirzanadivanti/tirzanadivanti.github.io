...
<body>
  ...
  <div class="row no-gutters jarnav">
    ...
    <div class="col-md-10 p-3 pt-2">
      <h4><i class="fas fa-clipboard-list"></i> DATA BARANG</h4>
      <a href="databartam.php" class="btn btn-dark tambah"><i class="fas fa-folder-plus"></i></a>
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $data['kat_barang']; ?></td>
                <td><?php echo $data['nama_barang']; ?></td>
                <td><?php echo $data['harga']; ?></td>
                <td><?php echo $data['stok']; ?></td>
                <td><?php echo $data['ket_barang']; ?></td>
                <td><img src="img/upload/<?php echo $data['gambar']; ?>" style="width:50px;" alt=""></td>
                <td><a href="databaredit.php?nama_barang=<?php echo $data['nama_barang']; ?>" class="btn btn-primary">Edit</a></td>
                <td><a href="databar_hapus.php?nama_barang=<?php echo $data['nama_barang']; ?>" onclick="return confirm('apakah anda yakin?')" class="btn btn-primary">Delete</a></td>
              </tr>
            <?php
            }
            ?>
