...
<head>
    ...
    <title>CAMP-UPrent | Artikel-Lengkap</title>
...
<body>
    ...
    $id = $_GET['id'];
    $query = "SELECT * FROM artikel WHERE id='$id'"; //buat query sql
    $hasil = mysqli_query($koneksi, $query); //jalankan query sql
    $data = mysqli_fetch_array($hasil);
    ?>
    <div class="container">
        <div class="posar-lengkap">
            <div class="kotak-gambar">
                <img src="img/upload/<?php echo $data['gambarar']; ?>" alt="">
            </div>
            <p class="judul-arleng"><span class="font-weight-bold"><?php echo $data['judul_ar']; ?></span></p>
            <p class="ket-arleng">By Admin | <?php echo $data['tgl']; ?></p>
            <p class="isi-arleng"><?php echo $data['isi']; ?></p>
        </div>
    </div>
