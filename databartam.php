...
<body>
  ...
  <div class="row no-gutters jarnav">
    ...
    <div class="col-md-10 p-3 pt-2">
      <h4><i class="fas fa-clipboard-list"></i> TAMBAH BARANG</h4>
      ...
      <div id="TambahBarang" class="tabcontent jartab">
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <select class="form-control" id="exampleFormControlSelect2" name="kat_barang">
          ...
          <div class="form-group">
            ...
            <textarea name="ket_barang" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
          <div class="form-group">
          ...
          @$query = "INSERT INTO barang VALUES ('$kat_barang','$nama_barang','$harga','$stok','$ket_barang','$gambar')";
          ...
          if (isset($_POST['kirim'])) {
            ...
            if ($hasil) {
              ...
              echo "<script>alert('Gagal Dibuat');
                document.location='databartam.php'</script>";
            }
          }
          ?>
        </form>
